...
if(length(nzv)>0) TrainData = TrainData[, -nzv] # 若沒有則不處理
```
...
* 羅吉斯回歸模型，詳細可以參考[GLM](https://www.rdocumentation.org/packages/rms/versions/5.1-2/topics/Glm)。
